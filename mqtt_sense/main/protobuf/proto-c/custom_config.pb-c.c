...
static const ProtobufCFieldDescriptor custom_config_request__field_descriptors[7] =
{
  {
    "info",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(CustomConfigRequest, serial_num),
    NULL,
    &protobuf_c_empty_string,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(CustomConfigRequest, device_name),
    NULL,
    &protobuf_c_empty_string,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(CustomConfigRequest, appliance_type),
    NULL,
    &protobuf_c_empty_string,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(CustomConfigRequest, device_model),
    NULL,
    &protobuf_c_empty_string,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    offsetof(CustomConfigRequest, device_modelcode),
    NULL,
    &protobuf_c_empty_string,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned custom_config_request__field_indices_by_name[] = {
  4,   /* field[4] = appliance_type */
  5,   /* field[5] = device_model */
  6,   /* field[6] = device_modelCode */
  3,   /* field[3] = device_name */
  0,   /* field[0] = info */
  2,   /* field[2] = serial_num */
  1,   /* field[1] = version */
};
